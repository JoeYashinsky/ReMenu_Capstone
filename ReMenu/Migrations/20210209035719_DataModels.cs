        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FavRestaurant = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FoodieId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Foodies", x => x.FoodieId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MealPicture = table.Column<string>(nullable: true),
                    FutureOrder = table.Column<string>(nullable: true),
                    FavMeal = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Meals", x => x.MealId);
                    table.ForeignKey(
                        name: "FK_Meals_Foodies_FoodieId",
                        column: x => x.FoodieId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "4254045e-4c9f-40c0-a814-0c2dc7c44102", "9db093d8-0b9b-4f79-a0b4-6fcd3d3640a6", "Foodie", "FOODIE" });
